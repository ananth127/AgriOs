...
export default function Index({ params: { locale } }: { params: { locale: string } }) {
    ...
    // Landing Page for Guest (Public Home)
    return (
        <main className="min-h-screen bg-slate-950 text-white selection:bg-green-500/30 overflow-x-hidden">
            ...
            <div className="relative pt-32 pb-20 px-6 flex flex-col items-center justify-center text-center">
                ...
                <div className="z-10 max-w-4xl mt-10">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-900 border border-white/10 text-xs font-semibold text-green-400 mb-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="/auth/signup" className="px-8 py-4 bg-green-500 hover:bg-green-400 text-slate-950 font-bold rounded-xl transition-all hover:scale-105 flex items-center gap-2 justify-center shadow-xl shadow-green-900/20">
                            {tAuth('signup_button')} <ArrowRight className="w-5 h-5" />
                        </Link>
                        <Link href="/features" className="px-8 py-4 bg-white/5 hover:bg-white/10 text-white font-semibold rounded-xl border border-white/10 transition-all hover:scale-105 flex items-center gap-2 justify-center">
                            View Features
                        </Link>
                    </div>
                </div>
...
function FeatureLink({ href, icon, label }: any) {
    return (
        <Link href={href} className="p-4 rounded-2xl bg-slate-900/50 border border-white/5 hover:border-green-500/30 transition-colors flex flex-col items-center gap-3 group">
            <div className="text-slate-400 group-hover:text-green-400 transition-colors">{icon}</div>
            <span className="font-semibold text-sm text-slate-300 group-hover:text-white">{label}</span>
        </Link>
    )
}
