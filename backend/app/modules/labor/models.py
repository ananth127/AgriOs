...
class FieldWorker(Base):
    ...
    worker_unique_id = Column(String, unique=True, index=True, nullable=False)
    user_unique_id = Column(String, index=True, nullable=False) # Employer (Farmer)
    linked_user_unique_id = Column(String, index=True, nullable=True) # If worker is a reg user
